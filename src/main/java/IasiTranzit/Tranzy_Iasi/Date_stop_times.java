...
public class Date_stop_times {
	private static final String API_URL = "https://api.tranzy.ai/v1/opendata/stop_times";
	private static final String API_KEY = "7DgYhGzTQc5Nn8FfFeuFmhCAWcbadYQEShUjwu3e"; // Inlocuieste cu cheia API
	private static final String ST_ID = "1"; // ID-ul agentiei
